...
type Student struct {
	...
	Name            string `gorm:"type:char(24);not null;CHARACTER SET utf8 COLLATE utf8_general_ci" form:"name" json:"name" binding:"required"`
	Sex             string `gorm:"type:char(3);not null;CHARACTER SET utf8 COLLATE utf8_general_ci" form:"sex" json:"sex" binding:"required"`
	Birthdate       string `gorm:"not null" form:"birthdate" json:"birthdate" binding:"required"`
	Ethnic          string `gorm:"type:char(20);not null;CHARACTER SET utf8 COLLATE utf8_general_ci" form:"ethnic" json:"ethnic" binding:"required"`
	IDNumber        string `gorm:"type:char(18);not null;unique_index" form:"idnumber" json:"idnumber" binding:"required"`
	PoliticalStatus string `gorm:"type:char(20);not null;CHARACTER SET utf8 COLLATE utf8_general_ci" form:"politicalstatus" json:"politicalstatus" binding:"required"`
